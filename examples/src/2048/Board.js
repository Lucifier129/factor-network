// copy from https://github.com/IvanVergiliev/2048-react
...
Tile.prototype.clone = function() {
	return Object.assign(Object.create(Tile.prototype), this)
}
...
Board.prototype.clone = function() {
	...
	for (var i = 0; i < this.cells.length; i++) {
		...
		for (var ii = 0; ii < this.cells[i].length; ii++) {
			var tile = this.cells[i][ii]
			var tileClone = this.cells[i][ii].clone()
			var index = this.tiles.indexOf(tile)
			cells[i].push(tileClone)
			if (index !== -1) {
				tiles[index] = tileClone
			}
		}
	}
